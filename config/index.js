export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxcbd5c3d04f35589a",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "cb44245ec1ddf30da468de9fa0827a58",
  ...
  USERS: [
    {
      ...
      id: "oaxea5ihxs6_riwi-oM4aLtq03wY",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "7zdm_c_U5n-7CzXhND5gUh5273oKDg7VFGepVH8gVzI",
      // 所在省份
      province: "湖北",
      // 所在城市
      city: "荆门",
  ...
  CALLBACK_TEMPLATE_ID: "7zdm_c_U5n-7CzXhND5gUh5273oKDg7VFGepVH8gVzI	",
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "7zdm_c_U5n-7CzXhND5gUh5273oKDg7VFGepVH8gVzI",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
